# Run one retrospective complexity assignment: prague EIP-7623
...
Read `TASK.md` completely, then read `package/manifest.yaml`, `package/rubric.md`, `package/eip.md`, and every file listed under `assessment_source_files` in the manifest. Assess only prague EIP-7623.
